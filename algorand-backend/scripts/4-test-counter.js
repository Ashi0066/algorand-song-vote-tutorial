...
let myaccount = algosdk.mnemonicToSecretKey("silk argue mountain solve marble knock effort zebra maid rally party scatter father useless subject room cool grape process pelican reunion evoke current absent scissors"); 
